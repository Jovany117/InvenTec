...
$sql = "INSERT INTO usuarios_analista (username, hashed_password) VALUES ('$username', '$hashedPassword')";

if ($conn->query($sql) === TRUE) {
    echo "<script>alert('Usuario registrado exitosamente'); window.location.href = 'login_analista.html';</script>";
