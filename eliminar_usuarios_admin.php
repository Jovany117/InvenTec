...
<head>
    ...
    <title>Editar, Eliminar y Modificar Contraseña de Usuarios</title>
    ...
    <table>
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo "<td><a href='eliminar_usuario.php?user=" . $row["user"] . "&host=" . $row["host"] . "' onclick=\"return confirm('¿Estás seguro de que deseas eliminar este usuario?');\">Eliminar</a></td>";
                echo "</tr>";
            }
        } else {
